...
import { Text, Button, Picker, Item, Input } from 'native-base';
...
class ProjectAddScreen extends React.PureComponent {
        ...
        return <View style={styles.singlePage}>
            ...
            <View style={styles.buttonSection}>
                <View style={styles.buttonContainer}>
                    <Button style={styles.button} onPress={() => this.nextPage('title')}>
    ...
    renderDescription = () => {
        return <View style={styles.singlePage}>
            {/* <KeyboardAvoidingView> */}
            <View style={styles.mainSection}>
                <Text style={styles.bigText}>Add a short description for your Project</Text>
                <View style={styles.nameContainer}>
                    <TextInput
                        style={styles.input}
                        // placeholder='First'
            ...
            <View style={styles.buttonSection}>
                <View style={styles.buttonContainer}>
                    <Button style={styles.button} onPress={() => this.nextPage('description')}>
                        <Text style={styles.buttonText}>Next</Text>
                    </Button>
                </View>
            </View>
    ...
    renderTimeline = () => {
        return <View style={styles.singlePage}>
            ...
            <View style={styles.buttonSection}>
                <View style={styles.buttonContainer}>
                    <Button style={styles.button} onPress={() => this.nextPage('timeline')}>
                        <Text style={styles.buttonText}>Next</Text>
                    </Button>
                </View>
            </View>
